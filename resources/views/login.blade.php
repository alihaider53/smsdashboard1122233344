...
<!-- Mirrored from xvelopers.com/demos/html/paper-panel/login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2019 14:44:45 GMT -->
<head>
    <meta charset="utf-8">
...
<main>
    <div id="primary" class="blue4 p-t-b-100 height-full responsive-phone">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="/img/icon/icon-plane.png" alt="">
                </div>
